...
class TakeDonations extends StatefulWidget with NavigationStates {
  @override
  _TakeDonationsState createState() => _TakeDonationsState();
}

class _TakeDonationsState extends State<TakeDonations>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(child: Text('Take Donation')),
      ),
      body: Column(
        children: [
          Padding(
